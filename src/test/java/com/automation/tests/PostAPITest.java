...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		Users users = new Users("Mohit", "Programmer"); //expected users obejct
		
		//object to json file:
		mapper.writeValue(new File("/Users/mohitkaushik/Downloads/APIAutomationUsingHTTPClient-master/src/main/java/com/qa/data/users.json"), users);
